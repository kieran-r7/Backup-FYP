...
'''
https://github.com/jwagemann/era5_in_gee/blob/master/cds_data_retrieve.py
Used to get the single level 2m temperature 
NEED TO CHANGE THE BELOW 
'''

os.chdir('/Users/admin/Documents/FInal_Semester_Project/Python/Data_Disk/ERA5/2014_daily_MVIMD/')
...
def getDataList(parameter):
    ...
    for i in df:
        ...
        filename = "era5_daily_"+parameter+"_"+str(i.year)+"_"+str(i.month).zfill(2)+"_"+str(i.day).zfill(2)+".nc"
...
filelist_2m = getDataList('mean_vertically_integrated_moisture_divergence')
